"""
control_CDF_spline_fitting_forecast_precip_JFM.py 

controls the forecast spline fitting for Jan,Feb,Mar

""" 
import os, sys
from CDF_spline_fitting_forecast_precip_v4 import \
    CDF_spline_fitting_forecast_precip_v4
