...
! f2py --opt='-O4' --opt='-Wno-tabs' -c -m qmapping_spline_fivexfive_flexiknot qmapping_spline_fivexfive_flexiknot.f90 cumgam.f90 gamma_inc.f90 error_f.f90 error_fc.f90 exparg.f90 gam1.f90 ipmpar.f90 pgamma.f90 dgamma.f90 qgamma.f90 rlog.f90 rexp.f90 dnorm.f90 pnorm.f90 qnorm.f90 gamma.f90 splev.f fpbspl.f

! then $ cp qmapping_spline_fivexfive_flexiknot.cpython-38-darwin.so qmapping_spline_fivexfive_flexiknot.so
