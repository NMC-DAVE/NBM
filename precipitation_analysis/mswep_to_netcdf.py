...
MSWEP data used in this procedure was v260, downloaded with instructions
from gloh2o.org.   They have since upgraded to v280, which Hylke Beck
says has more light precipitation.   The v280 data isn't used here.
...
# ---- define where the output data should be written

mswep_output_directory = '/Volumes/Backup Plus/mswep/'

# ---- the very first hour of the first day of the month
#      with MSWEP is stored in the previous month.  Define
#      that.
...
#      the Basemap interp requires.  Check for that and flip if 
#      necessary.
...
# --- read in the land-water mask. Also flip if necessary.
...
# --- read in the valid CCPA mask.  Note that this contains
