"""
quantile_map_ensemble_bymonth_andlead_v4.py cyyyymmddhh clead 
...
coded by: Tom Hamill, Feb-Mar 2021, tom.hamill@noaa.gov 
...
for idate, cyyyymmddhh in enumerate(date_list):
    ...
    for imem, cmem in enumerate(cmembers): 
        ...
        print ('   precip_gefsv12_on_ndfd[809,923] = ', precip_gefsv12_on_ndfd[809,923])
        ...
        print ('   offset_on_ndfd[809,923] = ', offset_on_ndfd[809,923])
        ...
        qmapped_precip = qmapping_spline(gefsv12_quantiles_on_ndfd, \
            ...
            ny_ndfd, nx_ndfd)
        print ('   qmapped_precip[809,923] = ', qmapped_precip[809,923])
        precip_ens_qmapped_ndfd[imem,:,:] = qmapped_precip[:,:]       
        offset_ens_ndfd[imem,:,:] = offset_on_ndfd[:,:]
