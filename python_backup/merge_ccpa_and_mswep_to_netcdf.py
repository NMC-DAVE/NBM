...
MSWEP on CONUS NDFD grid and merge and then save to a new netCDF file.
6-hourly precip accumulations, 2002-2019 period
...
for iyear in range(2020,2019):
    ...
    outfile = '/Volumes/NBM/conus_panal/'+cyear+cmonth+\
