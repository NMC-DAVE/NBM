""" control_qmap_hist_generation_x2_deck.py """
import os, sys

cseason = sys.argv[1] # 'cool', 'warm'
clead = sys.argv[2] # '024' etc, 3-digit number lead in hours
...
for cyyyymm in cyyyymms:   
    ...
    cmd = 'python qmap_reforecast_for_histogram_stats_thinned_x2.py '+ \
        cyyyymmddhh + ' ' + clead
    print (cmd,file=ouf)
ouf.close()
