...
for clead in ['24','48','72','96','120']:
    ...
    for warm_or_cold in ['cold']:
        ...
        #for efold_random in [50.0,100.0,150.0,200.0,250.0,300.0]:
        for efold_random in [200.0, 400.0, 600.0, 800.0]:
            for efold_bias in [400.0, 600.0, 800.0, 1000.0, 1200.0, 1400.0, 1600.0]:
        #for efold_random in [300.0]:
        #    for efold_bias in [1600.0]:
