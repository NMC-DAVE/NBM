"""
qmap_gefsv12_ensemble_ccpa_spline.py cyyyymmddhh clead 
...
for cmem in cmembers: 
    ...
    #print ('clead, cmem, cyyyymmddhh = ', clead, cmem, cyyyymmddhh)
    ...
    #print ('precip x section = ', precip_gefsv12_on_ndfd[ny_ndfd//2,nx_ndfd//4:nx_ndfd//2:5])
    ...
    #if cmem == 'c00':
    #    print ('spline_info_inv[ny_ndfd//2, nx_ndfd//2,:,:] = ', \
    #        spline_info_inv[ny_ndfd//2, nx_ndfd//2,:,:])
    #    print ('fraction_zero_ndfd = ',\
    #        fraction_zero_ndfd[ny_ndfd//2, nx_ndfd//2])
    #    print ('usegamma[ny_ndfd//2, nx_ndfd//2] = ', \
    #        usegamma[ny_ndfd//2, nx_ndfd//2])
    #print ('precip_gefsv12_on_ndfd[ny_ndfd//2, nx_ndfd//2] = ', \
    #    precip_gefsv12_on_ndfd[ny_ndfd//2, nx_ndfd//2])
    qmapped_precip = qmapping_spline(gefsv12_quantiles_on_ndfd, \
    	precip_gefsv12_on_ndfd, spline_info_inv, \
    	fraction_zero_ndfd, usegamma, ny_ndfd, nx_ndfd)
    #print ('qmapped_precip[ny_ndfd//2, nx_ndfd//2] = ', \
    #    qmapped_precip[ny_ndfd//2, nx_ndfd//2])  
