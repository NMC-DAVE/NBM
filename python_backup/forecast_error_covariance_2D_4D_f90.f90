SUBROUTINE forecast_error_covariance_2D_4D_f90( difference_3d, efold, &
	exponenty, npts, ndates, nlats, nlons, Bx_localized, Bx_localized_4D)
	
! sudo f2py --opt='-O4' -c -m forecast_error_covariance_2D_4D_f90 forecast_error_covariance_2D_4D_f90.f90    
!
! forecast_error_covariance_2D_4D_f90.F90
...
RETURN 
END SUBROUTINE forecast_error_covariance_2D_4D_f90
