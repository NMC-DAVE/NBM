"""
save_2019_bias_estimates_GEFSv12.py
"""
...
from KFgain_GEFSv12_biascorr_2019 import KFgain_GEFSv12_biascorr_2019
import numpy as np
from smooth_beta3d import smooth_beta3d
from decayavg_biascorrection_meantemp import decayavg_biascorrection_meantemp
...
npts = nlats*nlons
print ('max, min analyses_3d', np.max(analyses_3d))
print ('lats[:,0] = ',lats[:,0])
...
# ---- a revised decaying-average bias correction that uses bias mean of all 
#      points within 1.5 C
        
alpha = 1.0
print ('performing decay avg bias cor using mean of points with similar temps')
beta_3d = decayavg_biascorrection_meantemp(npts, nlats, nlons, \
    forecast_3d, analyses_3d, beta_3d, date_list_forecast, alpha)

# ---- verify, save decay average stats to file   
    
statsfile = cpath_errorstats + 'decayavg_meantemp_forecast_errorstats_2019_'+\
    clead+'h_.txt'
rmse, bias, mae = verify_forecasts(ndates, nlats, nlons, clead, \
    analyses_3d, forecast_3d, beta_3d, iskip, statsfile)
print ('decay avg rmse, bias, mae = ', rmse, bias, mae)    
...
#statsfile = cpath_errorstats + 'KFbiascorr_GEFSv12_2019_'+\
#    clead+'h.txt'
#rmse, bias, mae = verify_forecasts(ndates, nlats, nlons, clead, \
#    analyses_3d, forecast_3d, beta_3d, iskip, statsfile)
