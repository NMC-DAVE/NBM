...
class TaylorDiagram(object):
    ...
    def __init__(self, refstd,
        ...
        * extend: extend diagram to negative correlations
        ...
        ax.axis["left"].label.set_text(r"Normalized standard deviation ($\sigma_f$ / $\sigma_a$)")
        ...
        t = NP.linspace(0, self.tmax)  # new
        r = NP.zeros_like(t) + 0.5
        self.ax.plot(t, r, 'k--', label='_',lw=0.3)
        
        t = NP.linspace(0, self.tmax)
        r = NP.zeros_like(t) + 1.5
        self.ax.plot(t, r, 'k--', label='_',lw=0.3)
