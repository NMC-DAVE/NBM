...
#      oriented S to N as interp requires.  This CCPA data was
#      downloaded from ftp.emc.ncep.noaa.gov 
#      cd gc_wmb/yluo .   These data may not be there any more.
#      Contact yan.luo@noaa.gov for help getting the relevant data
#      off tape.
