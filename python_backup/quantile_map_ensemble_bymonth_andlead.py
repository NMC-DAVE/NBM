"""
quantile_map_ensemble_bymonth_andlead.py cyyyymmddhh clead 
...
def initialize_netCDF_probfiles(outfile, ncname, ny, nx, \
    ...
    probability_raw = ncout.createVariable('probability_raw','f4',\
        ('sample','threshold','yf','xf',),zlib=True,least_significant_digit=6)
...
def write_probabilities_to_netcdf (outfile, ncname, idate, cyyyymmddhh, \
    cyyymmddhh_fcst, prob_raw_out, prob_qmapped_out):    
...
for idate, cyyyymmddhh in enumerate(date_list):
    ...
    if netcdf_fullfield == True:
        ...
        istat = write_probabilities_to_netcdf(outfile, ncname, idate, \
            ...
            prob_qmapped_out)
        print ('   writing full field probabilities completed.')
    ...
    if netcdf_thinned == True:
        ...
        istat = write_probabilities_to_netcdf(outfile, ncname, idate, \
            ...
            prob_qmapped_thinned)
        print ('   writing thinned field probabilities completed.')
    ...
    if netcdf_upscaled == True:
        ...
        istat = write_probabilities_to_netcdf(outfile, ncname, idate, \
            ...
            prob_qmapped_upscaled)
        print ('   writing upscaled field probabilities completed.')   
