...
#print ('finalmask[nlats_ndfd//2, nlons_ndfd] = ', finalmask[nlats_ndfd//2, 0:nlons_ndfd:10] )
#print ('validmask_ccpa[nlats_ndfd//2, nlons_ndfd] = ', validmask_ccpa[nlats_ndfd//2, 0:nlons_ndfd:10] )
#print ('landmask[nlats_ndfd//2, nlons_ndfd] = ', landmask[nlats_ndfd//2, 0:nlons_ndfd:10] )

# ---- read in the mswep lat/lon to see if need to flip.

mswep_directory = '/Volumes/NBM/mswep/'
...
#for iyear in range(2004,2020,4):
for iyear in range(2020,2022):
    ...
    for iday in range(1,ndays+1):
        ...
        for chour in ['00','06','12','18',]:
            ...
            try:    
                #infile1 = '/Volumes/Backup Plus/ccpa/ccpa.'+cyyyymmdd+\
